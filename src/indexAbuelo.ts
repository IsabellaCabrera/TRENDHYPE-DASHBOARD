...
class AppContainer extends HTMLElement {
    ...
    constructor() {
        ...
        const filteredMediumPost = mediumPost.filter(post => post.id >= 1 && post.id <= 5);
        ...
        if (this.shadowRoot) {
            this.shadowRoot.innerHTML = `
              <link rel="stylesheet" href="../src/styles.css">
                ...
                <div class="parent">
                    <div class="moodBanner"> 
                        <mood-banner></mood-banner>
                        <div class="banner-container1">
                            <button class="bannerButton">You may be interested in</button>
                        </div>
                    </div>
                    <div class="todayMood"> 
                ...
                <div class="Users">
                    ...
                    <div class="related-user-father">
                        <div id="related-users-card"></div>
                    </div>
                </div>
                <div class="post">
            ...
            if (todaysMood) {
                ...
                todaysMood.setAttribute(Attribute2.profileimage, 'https://github.com/jeanalo/profilePicTrendhype/blob/main/profilepic.png?raw=true');
            ...
            const relatedUsersBanner = this.shadowRoot.querySelector('.related-users-banner');
            if (relatedUsersBanner) {
                relatedUsersBanner.setAttribute(AttributeUsersBanner.message, 'You may be interested in');
            }

            const relatedUsers = this.shadowRoot.querySelector('#related-users-card'); // Cambiar a ID
                this.relatedUsersRender.forEach(Element => {
                    if (relatedUsers) {
                        ...
                        // Las dos líneas anteriores sacarlas y meterlas en los post para follow y unfollow
                    }
                });
